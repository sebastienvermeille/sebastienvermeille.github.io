...
var documents = [{
    ...
    "title": "About me",
    "body": "Developer Advocate, enthusiast attracted by Clean Code concepts and keeping code enjoyable to work with (aka maintainable). LanguagesI consider myself as a language agnostic programmer beside the fact that I mostly use to program in JAVA. It’s just a syntax after all. The most important concepts are valid for all languages, what is required is the “Programmer spirit”. Here is a subset of languages I’ve ever used:  PHP (The first programming language I learned! if we exclude HTML/CSS) JVM languages (JAVA, Kotlin, Scala) C# (Unity) C/C++/ASM/PIC-C/FPGA Pascal/Delphi Javascript/Typescript Python/Ruby (I usually get something working when I need to use them but I am certainly not an expert there :)OSS supporterAs developer, I used to consume open source software (in professional life but also for private side projects). No doubt about the amazing job that these people do (biggup to them btw). Since a few years now, I also try to contribute to the open source software community. I am surely not maintainer of huge projects such as Linux Kernel but still I try to share what I can with others at my humble level alsovia this blog :) If you are interested in my open sources contributions you can have a look at my open source projects or my contributionson Github directly. "
    }, {
    "id": 2,
    "url": "https://cookiecode.dev/blog.html",
    "title": "Blog",
    "body": "  Blog                                                                   [Howto] Create a voice reminder for daily meeting using NodeRed 17 Jun 2022                     info “Pre requisiste”This article suppose you have a running nodered instance.  If you don’t have one yet have a look here first.                                                                                   nodered                                                                                                                                        sonos                                                                                                                                        hue                                                                                                                                        scrum                                                                                                                                                                                         [Howto] Convert a text to a speech audio file for free using TTSMP3 16 Jun 2022                    Sometimes you might need to have some audio sound based on text. Such tools are called TTS (Text to Speech). Many exists but rarely for free.                                                                                   tts                                                                                                                                                 Next page             1            2            3            4            5               "
    }, {
    "id": 3,
    ...
    "title": "Home",
    "body": "    Quote of the day                      The best way        to have a good idea is        to have a lot of ideas.             Linus Pauling (1901 – 1994, American chemist, author and educator)           Recent Posts                                                                           [Howto] Convert a text to a speech audio file for free using TTSMP3 16 Jun 2022                    Sometimes you might need to have some audio sound based on text. Such tools are called TTS (Text to Speech). Many exists but rarely for free.                                                                                   tts                                                                                                                                                                                             [Howto] Create your own app for UnRaid 14 Jun 2022                    Unraid provide an App store via its community app plugin:                                                                                   docker                                                                                                                                    "
    }, {
    "id": 5,
    "url": "https://cookiecode.dev/oss/",
    "title": "Open Source Software",
    "body": "      Open source contributions          OSS projects I maintain or contribute actively    :             {% for project in site. oss %}                                                                                                                            {{ project. title }}               {{ project. description }}                                             {% endfor %}  "
    }, {
    "id": 6,
    ...
    "title": "Blog - page 2",
    "body": "  Blog      {% for post in paginator. posts %}    {% include postbox. html %}    {% endfor %}              {% include pagination. html %}      "
    }, {
    "id": 8,
    "url": "https://cookiecode.dev/page3/",
    "title": "Blog - page 3",
    "body": "  Blog      {% for post in paginator. posts %}    {% include postbox. html %}    {% endfor %}              {% include pagination. html %}      "
    }, {
    "id": 9,
    "url": "https://cookiecode.dev/page4/",
    "title": "Blog - page 4",
    "body": "  Blog      {% for post in paginator. posts %}    {% include postbox. html %}    {% endfor %}              {% include pagination. html %}      "
    }, {
    "id": 10,
    "url": "https://cookiecode.dev/page5/",
    "title": "Blog - page 5",
    "body": "  Blog      {% for post in paginator. posts %}    {% include postbox. html %}    {% endfor %}              {% include pagination. html %}      "
    }, {
    "id": 11,
